...
1. aftermath_tracks_left_01 - open, information/visibility/terrain
2. aftermath_wildlife_scatter_01 - open, information/visibility
3. aftermath_storm_approach_01 - open/sea, hazard/time_pressure  
4. aftermath_evidence_scatter_01 - populated/derelict, information/opportunity
5. aftermath_sirens_converge_01 - city/industrial, time_pressure/visibility/social_friction
6. aftermath_structural_groan_01 - confined/derelict, terrain/hazard/time_pressure
7. aftermath_blame_spreads_01 - city/industrial, social_friction/visibility
8. aftermath_opportunity_window_01 - derelict/confined, opportunity/information
...
- **Environment**: populated, industrial, derelict
...
- **Environment**: populated, open, derelict
...
- **Environment**: confined, derelict, planar
...
- **Environment**: open, derelict, confined
...
- **Environment**: open, confined, derelict
...
- **Environment**: derelict, confined, open
